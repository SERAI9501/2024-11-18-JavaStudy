 ...
 *              
 *              }
 *        = 선택조건문 : true/false를 나눠서 따로 처리  56page
 *          형식)
 *           => 가장 많이 사용되는 조건문
 *           => 웹 : 모든 내용이 브라우저로 전송
 *                   ======= true/false
...
//프로그램은 비정상 종료가 없는 프로그램 , 사전에 오류 방지
//웹 => 비정상 종료를 방지 => 에러가 발생 => 건너뛴다
//8장 예외처리
...
public class 자바제어문 {
	...
	public static void main(String[] args) {
		...
		Scanner scan=new Scanner(System.in);//참조연산자 = > 객체지향
